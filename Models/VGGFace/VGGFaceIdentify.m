function outputID = VGGFaceIdentify(trainImgSet, trainPersonID, testPath, paramsPath, similarity_metric)
    ...
    % Constants
    executionEnvironment = "cpu";   % this network is too large for my gpu (GTX1650TI Laptop)
